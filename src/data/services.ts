/**
 * MAKLAID ADVOCATES practice areas — single source of truth for the services
...
export interface ServiceItem {
  /** URL segment for /services/[service] */
  slug: string;
  title: string;
  description: string;
...
export const services: ServiceItem[] = [
  {
    ...
    overview: [
      ...
      'The team regularly acts for listed companies, family businesses and foreign investors entering the Ugandan market, combining technical precision with a commercial instinct for what a deal actually needs.',
    ],
    process: [
      {
      ...
      },
      {
        ...
        description:
          'We handle filings with the Uganda Registration Services Bureau, sector regulators and local authorities through to issuance.',
      },
      {
    ...
    faq: [
      {
        question: 'How long does company incorporation take in Uganda?',
        answer:
          'A standard private limited company is typically registered within 7–14 working days once we have the proposed names, director details and shareholding. Companies requiring sector licences — banking, insurance, telecoms — take longer because of regulator clearance, which we manage end-to-end.',
      },
      {
  ...
  },
  {
    ...
    tag: 'Property',
    overview: [
      'Ugandan property moves fast, and mistakes are expensive. Every transaction we touch runs layered due diligence — official searches, encumbrance checks, rates and rent clearance — before a client commits money.',
    ...
    process: [
      ...
      {
        title: 'Conveyancing & consent',
        description:
          'Transfers, land board consents and stamp duty processed while your deposit sits safely in escrow.',
      },
      {
        title: 'Registration & handover',
        description:
          'We complete registration at the Ministry of Lands, confirm the new title issues correctly and manage possession and utilities handover.',
      },
    ],
    outcomes: [
    ...
    faq: [
      {
        ...
        answer:
          'At minimum: official search at the Ministry of Lands, encumbrances, rates and rent clearance, survey/registry-index-map verification and, for companies, a company search on the seller. Suspicious parcels fail early and cheaply.',
      },
      {
    ...
    faq: [
      {
        ...
        answer:
          'Arbitration offers confidentiality, speed and party-appointed decision-makers; courts offer precedent-based leverage and enforceable interim powers. Contract clauses decide much of this — we advise both on drafting and on strategy once a dispute exists.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Ugandan courts usually award party-and-party costs to the winner, taxed to a schedule. Recovery rarely covers everything, so budgets always assume some unrecovered spend.',
      },
    ],
  },
  {
    ...
    faq: [
      {
        question: 'How long does a divorce take in Uganda?',
        answer:
          'A joint (undefended) divorce typically concludes in 6–12 months. A contested divorce where parties disagree on grounds, custody or property can run 18 months or more. Mediation shortens most disputes considerably.',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'You are protected against self-incrimination under the Constitution of Uganda. We advise when a statement helps and when silence is the stronger strategy — never give one before speaking to us.',
      },
      {
        question: 'Can a criminal record be cleared later?',
        answer:
          'Depending on the offence and outcome, records may qualify for expungement or a certificate of good conduct. We assess eligibility and handle the application process.',
      },
    ],
  },
];
