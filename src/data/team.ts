...
export const team: TeamMember[] = [
  {
    ...
    education: [
      ...
      'LLM, Commercial Law, University of London',
      'Postgraduate Diploma in Legal Practice, Law Development Centre, Uganda',
    ],
    barAdmissions: [
      'Advocate of the High Court of Uganda, 2004',
  ...
  },
  {
    ...
    education: [
      ...
      'Postgraduate Diploma in Legal Practice, Law Development Centre, Uganda',
      'Certified Mediator, Alternative Dispute Resolution Centre, Uganda',
    ],
    barAdmissions: ['Advocate of the High Court of Uganda, 2012'],
  },
  {
    slug: 'dk-mutua',
    name: 'D. K. Mutua',
    ...
    bio: 'D. K. Mutua handles the transfers, leases and charges that keep Ugandan property moving. Known for pre-empting the registry delays and title defects that stall ordinary conveyances, he runs layered due diligence on every parcel before a client commits. Developers retain him for phased project documentation; families rely on him for succession plans that spare their heirs future courtrooms.',
    ...
    barAdmissions: ['Advocate of the High Court of Uganda, 2018', 'Member, Uganda Law Society'],
  },
];
